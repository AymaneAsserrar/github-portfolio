      ...
      {isMobile ? (
        <div className="max-w-2xl w-full flex flex-col items-center space-y-8 text-center flex-1 z-10">
          <motion.h1
            ...
            className="text-3xl xs:text-4xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-400 dark:to-cyan-300 pb-2"
          >
            {t.personalInfo.name}
          </motion.h1>
          <motion.div
